// DISCLAIMER
// I built this script about a year ago.
// I thought I built it so you can actually do seamless transitions between tracks but you can't.
// That kinda thing only works if you have a loading screen between tracks you want to transition.
// It was specific to the project it was written for and doesn't really work as well here. So much for portability =(
// HOWEVER, it still plays tracks that you can call anywhere with just a string reference.
// That's pretty cool.
// Doesn't allow randomisation between tracks with the same string reference.
    ...
    public static void PlayBGM(string track, TRANSITION transition)
    {
        ...
        switch (transition)
        {
            ...
            case TRANSITION.FADE:
                ...
                Instance.m_BGM.PlayClip(Instance.m_trackListBGM[track].clip);
                Instance.StartCoroutine("FadeInBGM");
                break;
            default:
                break;
        }
